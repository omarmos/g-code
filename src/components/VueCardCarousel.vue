<template>
  <div class="c-backdrop" :style="backdropStyle">
    <Iteration v-for="element in listToIterate" :iterant="element" :key="element.cMainId" :parent-mid-point="midpoint"
      :is-touch="isTouch" :is-scrolling="isScrolling" :is-mouse-up="isMouseUp" :is-init-scroll="isInitScroll"
      :side-card-opacity="sideCardOpacity" :header-options="intHeaderOptions" :footer-options="intFooterOptions"
      @ontouch="handleTouch" @onscroll="handleScroll" @initscrollcomplete="updateInitScroll">
